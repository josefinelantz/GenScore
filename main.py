...
from scripts.visualize import plot_box, plot_grouped_data, plot_stacked, plot_box_distribution, plot_hist_distribution
...
def main(vcf_path, output_dir):
    ...
    groups, counts, grouped_data = group_variants(df)
    ...
    plot_grouped_data(grouped_data, output_path=f"{output_dir}/grouped_data.png")
